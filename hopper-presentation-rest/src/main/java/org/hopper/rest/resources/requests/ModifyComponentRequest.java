...
public class ModifyComponentRequest {
  ...
  /** 0-based index into {@code HPresentation#getPages()} when {@link #pageRole} is {@code page}. */
  ...
  private String hopperComponentJson;
  ...
  /**
   * Gets hopperComponentJson
   *
   * @return value of hopperComponentJson
   */
  public String getHopperComponentJson() {
    return hopperComponentJson;
  }

  /**
   * Sets hopperComponentJson
   *
   * @param hopperComponentJson value of hopperComponentJson
   */
  public void setHopperComponentJson(String hopperComponentJson) {
    this.hopperComponentJson = hopperComponentJson;
  }
}
