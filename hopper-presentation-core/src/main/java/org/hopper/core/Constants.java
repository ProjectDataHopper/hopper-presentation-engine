...
public class Constants {
  ...
  /** The name of the standard components to load into the Hopper environment */
  public static final String XML_FILE_HOPPER_COMPONENT_PLUGINS = "hopper_components.xml";

  /** The system variable which points to the component plugins XML file */
  public static final String HOPPER_CORE_COMPONENTS_FILE = "HOPPER_CORE_COMPONENTS_FILE";

  /** The name of the standard data sources to load into the Hopper environment */
  public static final String XML_FILE_HOPPER_CONNECTOR_PLUGINS = "hopper_connectors.xml";

  /** The system variable which points to the component plugins XML file */
  public static final String HOPPER_CORE_CONNECTORS_FILE = "HOPPER_CORE_CONNECTORS_FILE";
