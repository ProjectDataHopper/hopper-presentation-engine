...
public class HMultiPagePDFTranscoder extends AbstractFOPTranscoder {

  /** Graphics2D instance that is used to paint to */
  protected HPDFDocumentGraphics2D graphics;

  /** Constructs a new {@link PDFTranscoder}. */
  public HMultiPagePDFTranscoder() {
    super();
    this.handler = new HFOPErrorHandler();
  }
  ...
  protected void transcode(Document document, String uri, TranscoderOutput output)
    ...
    graphics = new HPDFDocumentGraphics2D(isTextStroked());
    graphics
        .getPDFDocument()
        .getInfo()
